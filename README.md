...
* Peering with default VPC(if Required) if not required default no if not default peering created
...
* public_subnet_ids: list of 2 public subnet ids created [us-east-1a, us-east-1b]
* private_subnet_ids: list of 2 private subnet ids created [us-east-1a, us-east-1b]
* database_subnet_ids: list of 2 database subnet ids created [us-east-1a, us-east-1b]
